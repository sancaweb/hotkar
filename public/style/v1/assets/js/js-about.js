...
function updateAbOver(){
	easpie(document).ready(function() {
		$aboverw = easpie('.abover').innerWidth();
		$aboverh = easpie('.abover').innerHeight();

		
		easpie('.abbg').css({'width':$aboverw +'px','height':$aboverh +'px','left':-$aboverw+'px'});
		easpie('.socials-container').css({'left':$aboverw/2-28+'px','top':$aboverh/2-9+'px'});
