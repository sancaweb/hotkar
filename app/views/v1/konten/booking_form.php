  ...
  <body id="top" class="thebg" >
	...
	<div class="container">
		...
		<div class="container mt25 offset-0">
			...
			$total_bayar=$data_kamar->harga*$jml_kamar*$selisih_hari;
			...
			<div class="col-md-8 pagecontainer2 offset-0">
				<div class="padding30 grey">
					<span class="size16px bold dark left">Data Pemesan / Tamu </span>
					<div class="roundstep active right">1</div>
					<div class="clearfix"></div>
					<div class="line4"></div><br/><br/>
					<form class="form-horizontal" data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" action="<?php echo $this->uri->baseUri;?>index.php/booking/booking_review">
						<input type="hidden" name="checkin" value="<?php echo $checkin;?>">
						<input type="hidden" name="checkout" value="<?php echo $checkout;?>">
						<input type="hidden" name="id_kamar" value="<?php echo $data_kamar->id;?>">
						<input type="hidden" name="id_hotel" value="<?php echo $data_kamar->id_hotel;?>">
						<input type="hidden" name="jml_kamar" value="<?php echo $jml_kamar;?>">
						...
						<div class="form-group">
							  ...
							  <div class="col-sm-8" id="nama_guest_grup" >							  
								<input name="nama_guest" type="text" class="form-control input-lg" value="" required>
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-8" id="nama_guest_grup" >
								<input name="no_tlp" type="text" class="form-control input-lg" value="" required>
							...
							<div class="form-group">
							  ...
							  <textarea id="permintaan" class="form-control" name="permintaan"></textarea>
							...
							<div class="row">
								  <div class="col-md-4">
									...
									<div class="radio">
									  <label>
										...
										<input type="radio" name="nama_bank" id="optionsRadios1" value="1" checked>
								  ...
								  <div class="col-md-4">
									...
									<div class="radio">
									  <label>
										<input type="radio" name="nama_bank" id="optionsRadios1" value="2" checked>
								  ...
								  <div class="col-md-4">
									...
									<div class="radio">
									  <label>
										<input type="radio" name="nama_bank" id="optionsRadios1" value="3" checked>
					...
					<button onClick="window.location='<?php echo $this->uri->baseUri.'index.php/hotel/detail/'.base64_encode($id_hotel);?>';" class="bluebtn margtop20"> Back</button>
					<button onclick="return confirm('Pastikan data yang anda masukan sudah benar. Apa anda yakin ingin melanjutkan?')" type="submit" class="bluebtn margtop20">Pesan Sekarang</button>	
				...
				<div class="pagecontainer2 paymentbox grey">
					...
					<div class="hpadding30 margtop30">
							...
							<tr>							
								...
								<?php echo $selisih_hari;?> Malam</span>: 							
								<br/><?php echo date("M d, Y",strtotime($checkin)).'-'.date("M d, Y",strtotime($checkout));?></td>
							</tr>
							<tr>
							</tr>
						</table>
