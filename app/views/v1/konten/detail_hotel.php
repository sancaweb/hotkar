		...
		<div class="container mt25 offset-0">
			...
			<div class="col-md-8 pagecontainer2 offset-0">
				...
				<ul class="nav nav-tabs" id="myTabs" role="tablist">
					...
					<a href="#info" id="info-tab" role="tab" data-toggle="tab" aria-controls="info" aria-expanded="false">
					<span class="summary"></span>
					<span class="hidetext">Info</span>&nbsp;</a>
					</li>
					
					<li role="presentation" class="active">
					<a href="#roomrates" role="tab" id="roomrates-tab" data-toggle="tab" aria-controls="roomrates" aria-expanded="true">
					<span class="rates"></span>
					<span class="hidetext">Room rates</span>&nbsp;</a>
					</li>
					
					<li role="presentation" class="">
					<a href="#fasilitas" role="tab" id="fasilitas-tab" data-toggle="tab" aria-controls="fasilitas" aria-expanded="true">
					<span class="preferences"></span>
					<span class="hidetext">Fasilitas Hotel</span>&nbsp;</a>
					</li>
					
					<li role="presentation" class="">
					<a onclick="mySelectUpdate(); trigerJslider(); trigerJslider2(); trigerJslider3(); trigerJslider4(); "href="#reviews" role="tab" id="reviews-tab" data-toggle="tab" aria-controls="reviews" aria-expanded="true">
					<span class="reviews"></span>
					<span  class="hidetext">Reviews</span>&nbsp;</a>
					</li>
				...
				<div class="tab-content" id="myTabContent">
					...
					<div class="tab-pane fade active in" role="tabpanel" id="roomrates" aria-labelledby="roomrates-tab">
									...
									<div class="row">						
										...
										<div class="col-md-8 offset-0">											
											<div class="col-md-12 mediafix1">
												...
												<span class="opensans lblue size16">Jumlah Tamu <?php echo $kamar_hotel->kapasitas;?> Orang Dewasa</span>
												<div class="clearfix"></div>
												<div class="line2"></div>
											...
											<div class="form-group">
												...
												<input required name="checkin" type="text" class="form-control mySelectCalendar" id="datepicker<?php echo $kamar_hotel->id.'0';?>"  <?php echo $val_checkin;?>/>
											</div>
											
											<div class="form-group">
												<label for="checkout" class="size13">Checkout</label>
												<input required name="checkout" type="text" class="form-control mySelectCalendar" id="datepicker<?php echo $kamar_hotel->id.'1';?>" <?php echo $val_checkout;?>/>
											</div>
					...
					</div> <!-- end div id roomrates-->
					
					
					<div class="tab-pane fade" role="tabpanel" id="fasilitas" aria-labelledby="fasilitas-tab">
						<div class="hpadding20">
						<?php							
							if($fasilitas_hotel){
								$page=0;
					...
					<div class="tab-pane fade" role="tabpanel" id="reviews" aria-labelledby="reviews-tab">
						...
						<div class="line2"></div>							
						<div class="hpadding20" id="alertnya"></div>
							...
							if($this->hotel->related_hotel($view_detail_hotel->kecamatan,$limit_related)){
								...
								foreach($data_related as $data_related_hotel){
									if($data_related_hotel->id == $view_detail_hotel->id){
										...
										$url_gambar=$this->hotel->getone_gambar_hotel_by_idHotel($id_hotel);
										if($url_gambar){
											$url_gambar=$url_gambar->url_gambar;
										}else{
											$url_gambar='blank.jpg';
										}
									?>										
										<div class="cpadding1 ">
										<div class="row">
											<div class="col-md-4 left">											
												...
												<img src="<?php echo $this->uri->baseUri;?>upload/gambar_hotel/thumbs/<?php echo $url_gambar;?>" class="left mr20" alt="" style="width:96px;height:61px"/>
												</a>
											</div>
