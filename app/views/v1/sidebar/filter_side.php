	...
	<div id="collapse1" class="collapse in">
		<div class="hpadding20">
			<div class="checkbox">
				<label>
				  <input type="checkbox"><img src="<?php echo $this->uri->baseUri.STYLE;?>images/filter-rating-5.png" class="imgpos1" alt=""/> 5 Stars
				</label>
			</div>
			<div class="checkbox">
				<label>
				  <input type="checkbox"><img src="<?php echo $this->uri->baseUri.STYLE;?>images/filter-rating-4.png" class="imgpos1" alt=""/> 4 Stars
				</label>
			</div>
			<div class="checkbox">
				<label>
				  <input type="checkbox"><img src="<?php echo $this->uri->baseUri.STYLE;?>images/filter-rating-3.png" class="imgpos1" alt=""/> 3 Stars
				</label>
			</div>
			<div class="checkbox">
				<label>
				  <input type="checkbox"><img src="<?php echo $this->uri->baseUri.STYLE;?>images/filter-rating-2.png" class="imgpos1" alt=""/> 2 Stars
				</label>
			</div>
			<div class="checkbox">
				<label>
				  <input type="checkbox"><img src="<?php echo $this->uri->baseUri.STYLE;?>images/filter-rating-1.png" class="imgpos1" alt=""/> 1 Star
				</label>
			</div>	
		</div>
